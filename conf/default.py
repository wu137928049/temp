...
APP_ID = 'profession'
APP_TOKEN = '250730a7-5aaf-4fc5-a6d4-88b8b3db9eab'
# 蓝鲸智云开发者中心的域名，形如：http://paas.bking.com
BK_PAAS_HOST = 'paas.bk2.com'
...
MIDDLEWARE_CLASSES = (
    ...
    'common.middlewares.CountAddstu',
    #将此中间件与common的放在一起了。
    # 'utils.yzlogin.CountAddstu',
)
...
# 项目路径
#这里是获取到default.py所在的路径的文件夹名称，也就是conf
PROJECT_PATH = os.path.dirname(os.path.abspath(__file__))
#获得到文件夹conf所在的文件夹的名称,也就是temp
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'temp/static/uploads')

#Cache
#这里我们不需要用分布式，所以就用django本地的缓存即可。
# CACHES = {
#     "default":{
...
#             # pickle默认有四个版本，1，2，3，4，性能最高的是4，使用-1默认最后一个。
#             "PICKLE_VERSION": -1,
#         }
#     }
# }
